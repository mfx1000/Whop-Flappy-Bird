    ...
    return (
        <div className="w-full max-w-md bg-black/50 backdrop-blur-sm p-8 rounded-lg shadow-xl border border-white/20 text-center">
            ...
            <div className="flex items-center justify-center gap-2">
                ...
                <input type="number" step="0.01" min="1.00" value={price} onChange={(e) => setPrice(e.target.value)} className="w-48 bg-gray-800 text-white text-4xl font-bold text-center rounded-lg p-2 border-2 border-gray-600 focus:border-yellow-400 focus:outline-none" />
            </div>
            ...
            <div className="mt-6 pt-4 border-t border-white/10 text-xs text-gray-300">
                <p>Payouts are processed daily. The prize pool is split: 70% to the winner, 15% will go to the app creator and 15% will go to the whop owner.</p>
            </div>

            <button onClick={handleSavePrice} disabled={isLoading} className="w-full mt-6 rounded-lg px-8 py-4 text-xl font-semibold text-white shadow-lg transition-transform active:scale-95 disabled:bg-gray-500 disabled:cursor-not-allowed bg-green-500 hover:bg-green-600">
